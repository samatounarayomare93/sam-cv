"""Root compatibility module for helper functions and launcher entrypoint."""
...
def main() -> int:
    """Compatibility entrypoint for launcher scripts."""
    from core import main_bot as core_main_bot

    asyncio.run(core_main_bot.run_orchestrator())
    return 0
